...
const SliderImage = (props: SliderImageProps) => {
  ...
  return (
    <section className="slider-panel" data-testid="slider-panel" style={{ backgroundImage: `url(${img})` }}>
      <div className="slider_text text">
        <h2 className="text_service-name" data-testid="text_service-name">{serviceName}</h2>
