...
test('show full info', async () => {
  vi.mock('../../../db/operations', () => ({ getServiceByType: vi.fn().mockImplementation(() => fullMockData.data)}));
...
test('render without name', () => {
  vi.mock('../../../db/operations', () => ({ getServiceByType: vi.fn().mockImplementation(() => noNameMockData.data)}))
  render(<CostInfo id={'1'} />);
