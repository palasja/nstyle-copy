import { YMaps, Map, ZoomControl, TrafficControl, RulerControl, GeolocationControl, SearchControl, TypeSelector, Placemark } from '@pbe/react-yandex-maps';
    ...
    <>
      ...
      <section className='info'>
        <div className='info-map'>
          <YMaps >
            <Map defaultState={{ center: [53.951786, 27.681514], zoom: 14, controls: [], }} width={'100%'} height={400}>
